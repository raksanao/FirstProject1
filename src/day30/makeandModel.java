...
//                            " Car Model is " + eachCarSplitted[1]   );
        ...
        for (String eachCar : cars) {
            ...
            if (eachCar.startsWith("Honda")) {
                ...
                //find the car with model has only 2 character

                // print them out get the car
              for(String eachCar2:cars){
                  String[]eachCarSplited=eachCar2.split("-");
                  if(eachCarSplited[1].length()==2){
                      System.out.println(eachCar2);
                  }
